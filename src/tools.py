...
class ToolLogger:
    ...
    def set_session_id(self, session_id: str) -> None:
        """Start a fresh persistent log file for a session."""
        self.session_id = session_id
...
def create_calculator_tool(logger: ToolLogger):
    """Create a calculator tool that evaluates basic arithmetic safely."""
    ...
    def calculator(expression: str) -> str:
        ...
        try:
            ...
            error = f"Error calculating expression: {exc}"
